...
boundaries are recorded in the companion API ADR-0025 and SDK ADR-0043.
...
- GitHub currently reports this draft mergeable. The companion API has been rebased and reports mergeable; review its
  remaining release gates before publishing. No documentation deployment or live
  API-backed tool catalog regeneration was performed.
- 2026-09-07T19:19:31+00:00: Updated the public package name to `@trytilde/sdk`, reference
  paths to Dispatch, and the existing `context.session.tools` object contract.
- Related API PR: https://github.com/trytilde/api/pull/276. Related SDK PR: https://github.com/trytilde/dispatch/pull/154.
