...
Memory banks and wikis can be workspace-owned or personal. A personal resource has no team ID: its owner has full create, read, update, delete, list, and administration rights, while organization and system administrators retain administrative access. A workspace resource remains visible to members of that workspace. Pages, revisions, assets, memories, and lifecycle records inherit the ownership of their bank or wiki.
