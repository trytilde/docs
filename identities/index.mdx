...
Without an invitation or existing membership, Tilde asks you to name your first
organization and team. Submitting this setup creates the organization, team,
identity, and administrative membership before opening home. Retrying setup
reuses the same workspace. Clerk webhooks reconcile account lifecycle only.

The hosted [account-linking flow](/identities/account-linking) can connect an
