...
When the calling runtime scopes its MCP connection to a ChatKit session, the delegated conversation is recorded as a child of that session and Mission Control shows the two together instead of as unrelated conversations.
